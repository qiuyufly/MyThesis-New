...
\begin{subfigure}{.6\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/BoxPlot_Mode1.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/BoxPlot_Mode1.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Mode 1}
  \label{fig:ShapeDifference-a} 
\end{subfigure} 
\begin{subfigure}{.6\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/BoxPlot_Mode2.jpg}}
...
\end{subfigure}
\begin{subfigure}{.6\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/BoxPlot_Mode3.jpg}}
