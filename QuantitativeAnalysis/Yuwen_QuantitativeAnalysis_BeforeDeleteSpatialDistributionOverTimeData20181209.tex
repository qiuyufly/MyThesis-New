...
\paragraph{Subpleural to internal:} The distance from the abnormalities to the boundary of the lung and to the center of the lung were measured to analyze the location of disease with respect to the disease from lung surface. To be specific, the center location of each connected cluster of disease area was firstly extracted, and the subpleural to internal distance percentage $R_{subpleural}$ of each connected cluster, which described how far was the connected cluster from the lung surface, was then calculated as in the diagram shown in Figure \ref{fig:SubpleuralMethod}
...
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseAgainstHeightTime2.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseAgainstHeightTime2.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left ground-glass time 2}
  \label{fig:DiseaseAgainstHeightOverTime1-c} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseAgainstHeightTime2.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseAgainstHeightTime2.jpg}
  \caption{Right ground-glass time 2}
  \label{fig:DiseaseAgainstHeightOverTime1-d}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseAgainstHeightTime3.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseAgainstHeightTime3.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left ground-glass time 3}
  \label{fig:DiseaseAgainstHeightOverTime1-e} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseAgainstHeightTime3.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseAgainstHeightTime3.jpg}
  \caption{Right ground-glass time 3}
  \label{fig:DiseaseAgainstHeightOverTime1-f}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseAgainstHeightTime4.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseAgainstHeightTime4.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left ground-glass time 4}
  \label{fig:DiseaseAgainstHeightOverTime1-g} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseAgainstHeightTime4.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseAgainstHeightTime4.jpg}
...
\begin{subfigure}{.41\linewidth}% set image scale
  ...
  %\includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseAgainstHeight.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
	\begin{overpic}[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungReticularDiseaseAgainstHeightTime1.jpg}
      \put(33,75){\bf{Left lung}}
  \end{overpic}
  \caption{Left reticular time 1}
  \label{fig:DiseaseAgainstHeightOverTime2-a} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
...
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungReticularDiseaseAgainstHeightTime2.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungReticularDiseaseAgainstHeightTime2.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left reticular time 2}
  \label{fig:DiseaseAgainstHeightOverTime2-c} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungReticularDiseaseAgainstHeightTime2.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungReticularDiseaseAgainstHeightTime2.jpg}
  \caption{Right reticular time 2}
  \label{fig:DiseaseAgainstHeightOverTime2-d}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungReticularDiseaseAgainstHeightTime3.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungReticularDiseaseAgainstHeightTime3.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left reticular time 3}
  \label{fig:DiseaseAgainstHeightOverTime2-e} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungReticularDiseaseAgainstHeightTime3.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungReticularDiseaseAgainstHeightTime3.jpg}
  \caption{Right reticular time 3}
  \label{fig:DiseaseAgainstHeightOverTime2-f}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungReticularDiseaseAgainstHeightTime4.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungReticularDiseaseAgainstHeightTime4.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left reticular time 4}
  \label{fig:DiseaseAgainstHeightOverTime2-g} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungReticularDiseaseAgainstHeightTime4.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungReticularDiseaseAgainstHeightTime4.jpg}
...
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseAgainstHeightTime2.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseAgainstHeightTime2.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left honeycomb time 2}
  \label{fig:DiseaseAgainstHeightOverTime3-c} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseAgainstHeightTime2.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseAgainstHeightTime2.jpg}
  \caption{Right honeycomb time 2}
  \label{fig:DiseaseAgainstHeightOverTime3-d}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scal3
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseAgainstHeightTime3.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseAgainstHeightTime3.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left honeycomb time 3}
  \label{fig:DiseaseAgainstHeightOverTime3-e} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseAgainstHeightTime3.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseAgainstHeightTime3.jpg}
  \caption{Right honeycomb time 3}
  \label{fig:DiseaseAgainstHeightOverTime3-f}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseAgainstHeightTime4.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseAgainstHeightTime4.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left honeycomb time 4}
  \label{fig:DiseaseAgainstHeightOverTime3-g} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseAgainstHeightTime4.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseAgainstHeightTime4.jpg}
...
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseAgainstHeightTime2.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseAgainstHeightTime2.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left emphysema time 2}
  \label{fig:DiseaseAgainstHeightOverTime4-c} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseAgainstHeightTime2.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseAgainstHeightTime2.jpg}
  \caption{Right emphysema time 2}
  \label{fig:DiseaseAgainstHeightOverTime4-d}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseAgainstHeightTime3.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseAgainstHeightTime3.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left emphysema time 3}
  \label{fig:DiseaseAgainstHeightOverTime4-e} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseAgainstHeightTime3.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseAgainstHeightTime3.jpg}
  \caption{Right emphysema time 3}
  \label{fig:DiseaseAgainstHeightOverTime4-f}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseAgainstHeightTime4.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseAgainstHeightTime4.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left emphysema time 4}
  \label{fig:DiseaseAgainstHeightOverTime4-g} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseAgainstHeightTime4.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseAgainstHeightTime4.jpg}
...
\begin{subfigure}{.41\linewidth}% set image scale
  ...
  \end{overpic}
  \caption{Left ground-glass time 1}
  \label{fig:DiseaseADorsoToVentralOverTime1-a} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
...
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseDorsoToVentralTime2.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseDorsoToVentralTime2.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left ground-glass time 2}
  \label{fig:DiseaseADorsoToVentralOverTime1-c} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseDorsoToVentralTime2.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseDorsoToVentralTime2.jpg}
  \caption{Right ground-glass time 2}
  \label{fig:DiseaseADorsoToVentralOverTime1-d}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseDorsoToVentralTime3.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseDorsoToVentralTime3.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left ground-glass time 3}
  \label{fig:DiseaseADorsoToVentralOverTime1-e} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseDorsoToVentralTime3.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseDorsoToVentralTime3.jpg}
  \caption{Right ground-glass time 3}
  \label{fig:DiseaseADorsoToVentralOverTime1-f}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseDorsoToVentralTime4.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseDorsoToVentralTime4.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left ground-glass time 4}
  \label{fig:DiseaseADorsoToVentralOverTime1-g} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseDorsoToVentralTime4.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungGroundglassDiseaseDorsoToVentralTime4.jpg}
  \caption{Right ground-glass time 4}
...
\begin{subfigure}{.41\linewidth}% set image scale
  ...
  %\includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungGroundglassDiseaseAgainstHeight.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
	\begin{overpic}[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungReticularDiseaseDorsoToVentralTime1.jpg}
      \put(33,75){\bf{Left lung}}
  \end{overpic}
  \caption{Left reticular time 1}
  \label{fig:DiseaseDorsoToVentralOverTime2-a} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
...
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungReticularDiseaseDorsoToVentralTime2.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungReticularDiseaseDorsoToVentralTime2.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left reticular time 2}
  \label{fig:DiseaseDorsoToVentralOverTime2-c} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungReticularDiseaseDorsoToVentralTime2.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungReticularDiseaseDorsoToVentralTime2.jpg}
  \caption{Right reticular time 2}
  \label{fig:DiseaseDorsoToVentralOverTime2-d}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungReticularDiseaseDorsoToVentralTime3.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungReticularDiseaseDorsoToVentralTime3.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left reticular time 3}
  \label{fig:DiseaseDorsoToVentralOverTime2-e} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungReticularDiseaseDorsoToVentralTime3.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungReticularDiseaseDorsoToVentralTime3.jpg}
  \caption{Right reticular time 3}
  \label{fig:DiseaseDorsoToVentralOverTime2-f}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungReticularDiseaseDorsoToVentralTime4.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungReticularDiseaseDorsoToVentralTime4.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left reticular time 4}
  \label{fig:DiseaseDorsoToVentralOverTime2-g} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungReticularDiseaseDorsoToVentralTime4.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungReticularDiseaseDorsoToVentralTime4.jpg}
  \caption{Right reticular time 4}
...
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseDorsoToVentralTime2.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseDorsoToVentralTime2.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left honeycomb time 2}
  \label{fig:DiseaseDorsoToVentralOverTime3-c} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseDorsoToVentralTime2.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseDorsoToVentralTime2.jpg}
  \caption{Right honeycomb time 2}
  \label{fig:DiseaseDorsoToVentralOverTime3-d}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scal3
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseDorsoToVentralTime3.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseDorsoToVentralTime3.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left honeycomb time 3}
  \label{fig:DiseaseDorsoToVentralOverTime3-e} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseDorsoToVentralTime3.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseDorsoToVentralTime3.jpg}
  \caption{Right honeycomb time 3}
  \label{fig:DiseaseDorsoToVentralOverTime3-f}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseDorsoToVentralTime4.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungHoneycombDiseaseDorsoToVentralTime4.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left honeycomb time 4}
  \label{fig:DiseaseDorsoToVentralOverTime3-g} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseDorsoToVentralTime4.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungHoneycombDiseaseDorsoToVentralTime4.jpg}
  \caption{Right honeycomb time 4}
...
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseDorsoToVentralTime2.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseDorsoToVentralTime2.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left emphysema time 2}
  \label{fig:DiseaseDorsoToVentralOverTime4-c} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseDorsoToVentralTime2.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseDorsoToVentralTime2.jpg}
  \caption{Right emphysema time 2}
  \label{fig:DiseaseDorsoToVentralOverTime4-d}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseDorsoToVentralTime3.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseDorsoToVentralTime3.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left emphysema time 3}
  \label{fig:DiseaseDorsoToVentralOverTime4-e} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseDorsoToVentralTime3.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseDorsoToVentralTime3.jpg}
  \caption{Right emphysema time 3}
  \label{fig:DiseaseDorsoToVentralOverTime4-f}
\end{subfigure}
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseDorsoToVentralTime4.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/LeftLungEmphysemaDiseaseDorsoToVentralTime4.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{Left emphysema time 4}
  \label{fig:DiseaseDorsoToVentralOverTime4-g} 
\end{subfigure} 
\begin{subfigure}{.41\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseDorsoToVentralTime4.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/RightLungEmphysemaDiseaseDorsoToVentralTime4.jpg}
  \caption{Right emphysema time 4}
...
\begin{subfigure}{.46\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/GroundglassLobarRegionDiseaseDistributionOverTime.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/GroundglassLobarRegionDiseaseDistributionOverTime.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{}
  \label{fig:LobarRegionDiseaseDistributionOverTime-a} 
\end{subfigure} 
\hspace{.3in}
\begin{subfigure}{.46\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/ReticularLobarRegionDiseaseDistributionOverTime.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/ReticularLobarRegionDiseaseDistributionOverTime.jpg}
  \caption{}
  \label{fig:LobarRegionDiseaseDistributionOverTime-b}
\end{subfigure}
\begin{subfigure}{.46\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/HoneycombLobarRegionDiseaseDistributionOverTime.jpg}} 
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/HoneycombLobarRegionDiseaseDistributionOverTime.jpg} %trim={<left> <lower> <right> <upper>}, set the cut scale
  \caption{}
  \label{fig:LobarRegionDiseaseDistributionOverTime-c} 
\end{subfigure} 
\hspace{.3in}
\begin{subfigure}{.46\linewidth}% set image scale
  \sbox0{\includegraphics{QuantitativeAnalysis/Image/EmphysemaLobarRegionDiseaseDistributionOverTime.jpg}}
  \includegraphics[width=\linewidth,trim={{.0\wd0} {.0\wd0} {.0\wd0} {.0\wd0}},clip]{QuantitativeAnalysis/Image/EmphysemaLobarRegionDiseaseDistributionOverTime.jpg}
  \caption{}
