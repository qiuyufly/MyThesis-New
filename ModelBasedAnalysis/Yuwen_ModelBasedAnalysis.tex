...
\hline
\multirow{2}*{Patient 1} & Time point 1 & 0.108 & 0.070 & 0.064\\	
\cline{2-5}
~ & Time point 2 & 0.108 & 0.070 & 0.060 \\
\cline{2-5}
~ & Time point 3 & 0.106 & 0.067 & 0.066\\			
\hline
\multirow{2}*{Patient 2} & Time point 1 & 0.120 & 0.099 & 0.089 \\	
\cline{2-5}
...
\newgeometry{bottom=1.0cm, right=5.0mm} %set the left margin of page
\begin{landscape}
\begin{table}[htbp]
\centering
...
\hline
\multirow{2}*{\bf{Patient No.}} & \multirow{2}*{\bf{Time point}} & \multicolumn{3}{|c|}{\bf{PVP}} & \multicolumn{3}{|c|}{\bf{PVR}} & \multicolumn{3}{|c|}{\bf{PVV}}\\ 
\cline{3-11}
...
\newgeometry{bottom=1.0cm, left=6.0mm} %set the left margin of page
\begin{landscape}
\begin{table}[htbp]
\centering
