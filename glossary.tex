...
\newacronym{fev1}{$FEV_1$}{forced expiratory volume in 1 second}
\newacronym{fvc}{FVC}{forced vital capacity}
\newacronym{fev1/fvc}{$FEV_1/FVC$}{the ratio of the forced expiratory volume in the first one second to the forced vital capacity of the lungs}
...
\newacronym{rdh}{$R_dH$}{Horsfield diameter ratios}
\newacronym{rds}{$R_dS$}{Strahler diameter ratio}
\newacronym{rbc}{RBC}{red blood cell}
\newacronym{paao2}{$P_{A-a} O_2$}{alveolar-arterial pressure difference for oxygen}
